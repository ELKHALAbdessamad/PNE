...
EMAIL_HOST_USER = 'elkhala826@gmail.com'  # Votre adresse email
EMAIL_HOST_PASSWORD = 'trit qbmh jydg eahx'  # Votre mot de passe ou mot de passe d'application
DEFAULT_FROM_EMAIL = 'elkhala826@gmail.com'  # L'adresse email par défaut
